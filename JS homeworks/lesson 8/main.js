...
// const {title, monthDuration, hourDuration, modules} = coursesArrayElement
//    const titleDiv =  document.createElement('div')
//     titleDiv.innerText = `${title}`
//     divElement.append(titleDiv)
//     const duration1 = document.createElement('div')
//     duration1.innerText = `monthDuration = ${monthDuration}`
//     const duration2 = document.createElement('div')
//     duration2.innerText = `hourDuration = ${hourDuration}`
//     divElement.append(duration2,duration1)
//     const moduls = document.createElement('ul')
//     divElement.append(moduls)
//     for (const module of modules) {
//          const value = document.createElement('li')
//         value.innerText = `${module}`
//         moduls.append(value)
//     }
// }
...
// document.body.append(mainDiv.cloneNode(true))
...
//         const {title,monthDuration } = coursesAndDurationArrayElement
//     const mainDiv = document.createElement('div')
//     mainDiv.innerText = `Title - ${title}, monthDuration - ${monthDuration} `
//     document.body.append(mainDiv)
// }
